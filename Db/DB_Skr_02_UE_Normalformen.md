...
in die [[DB_Skr_02_Normalformen#1. Normalform|1.NF]] durch Atomarisieren:
...
- als [[DB_Skr_01_Einfuehrung#**Primärschlüssel**|Primär-Schlüssel]] wird *CdId* gemeinsam mit der *Track*-Nummer gewählt

![CD-Lieder](bilder/NF_CD_02.png)

in die [[DB_Skr_02_Normalformen#2. Normalform|2.NF]] durch funktional unabhängige Attribute:

- *Album/Interpret/Gründungsjahr* hängt nur von einem Teil des [[DB_Skr_01_Einfuehrung#**Primärschlüssel**|Primärschlüssels]] ab, von der *CdId*:  **CdId → (Album, Interpret, Gründungsjahr)**
...
Transformation in die [[DB_Skr_02_Normalformen#3. Normalform|3te Normalform]]:
...
- gehen Sie dabei auf die Begriffe: [[DB_Skr_02_Normalformen|Normalformen]], Anomalien, Redundanzfreiheit, Funktionale Abhängigkeit, Minimalität des Schlüssels ein.
